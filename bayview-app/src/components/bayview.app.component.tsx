...
import "../App.css";
import { ImagesGallery } from "./gallery/gallery.component";
import { TopNavBar } from "./navbar/top.navbar.component";

export const BayviewApp = (): ReactElement => {
